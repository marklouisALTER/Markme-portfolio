    ...
    >
        ...
        >
            ...
            <p
                ...
                className={`font-ubuntu ${isDark ? 'text-gray-400': 'text-gray-500'}`}>Here's all my work experience</p>

            <h3 
                data-aos="fade-up"
                data-aos-delay="200"
                data-aos-anchor-placement="top-bottom" 
                className={`font-ubuntu text-3xl ${isDark ? 'text-brand-primary': 'text-brand-secondary'}`}>My Work Experiences</h3>
            </div>
                    ...
                    <Timeline
                        ...
                        },
                        {
                            ...
                            <div className='flex justify-between'>
                                ...
                                <div className='flex gap-2'>
                                    <ClockCircleOutlined className={`${isDark ? 'text-brand-primary' : 'text-brand-secondary'}`} />
                                    <small className={`font-ubuntu font-light ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Febuary 2024 - June 2024</small>
                                </div>
                            </div>
                            <ul className='mt-2'>
                        ...
                        },
                        {
                            ...
                            <div 
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <div className='flex gap-2'>
                                        <ClockCircleOutlined className={`${isDark ? 'text-brand-primary' : 'text-brand-secondary'}`} />
                                        <small className={`font-ubuntu font-light ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>August 2023 - March 2024</small>
                                    </div>
                                </div>
                                <ul className='mt-2'>
